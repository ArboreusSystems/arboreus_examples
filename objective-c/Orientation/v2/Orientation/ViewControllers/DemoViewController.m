...
-(void) viewWillAppear:(BOOL)animated {
	...
	switch ([[UIDevice currentDevice] orientation]) {
		case UIDeviceOrientationLandscapeLeft:
			NSLog(@"Orientation: LandscapeLeft"); break;
		case UIDeviceOrientationLandscapeRight:
			NSLog(@"Orientation: LandscapeRight"); break;
		case UIDeviceOrientationPortrait:
			NSLog(@"Orientation: Portrait"); break;
		case UIDeviceOrientationPortraitUpsideDown:
			NSLog(@"Orientation: PortraitUpsideDown"); break;
		case UIDeviceOrientationFaceUp:
			NSLog(@"Orientation: FaceUp"); break;
		case UIDeviceOrientationFaceDown:
			NSLog(@"Orientation: FaceDown"); break;
		default:
			NSLog(@"Orientation: Unknown"); break;
	}
}
