...
-(instancetype) initWithProduct:(AStoreKitHandlerProduct*)inProduct {
	...
	if (self) {
		...
		[_pLabelPrice setText:[NSString stringWithFormat:@"%@",_pProduct.pPrice]];
...
-(void) mActionBuyProduct:(id)inSender {
	...
	NSLog(@"CELL Buy product: %@",_pProduct.pID);
	[_pStoreKit mBuyProduct:_pProduct.pID];
}
