...
-(void) mActionGetProducts:(id)inSender {
	...
	NSMutableSet<NSString*>* oAllIDs = [[NSMutableSet alloc] initWithSet:_pStoreKit.pItems.pConsumable];
	oAllIDs = [[oAllIDs setByAddingObjectsFromSet:_pStoreKit.pItems.pNonConsumable] mutableCopy];
	oAllIDs = [[oAllIDs setByAddingObjectsFromSet:_pStoreKit.pItems.pRenewableSubscriptions] mutableCopy];
	oAllIDs = [[oAllIDs setByAddingObjectsFromSet:_pStoreKit.pItems.pNonRenewableSubscriptions] mutableCopy];
	
	[_pStoreKit mRequestProducts:oAllIDs];
}
