			...
			DelegateChoice {
				...
				delegate: Rectangle {
					...
					Component.onCompleted: {
						...
						console.log("oTableViewDelegateName created with index:",model.index,"display:",model.display);
					}
				}
			}
			...
			DelegateChoice {
				...
				delegate: Rectangle {
					...
					Component.onCompleted: {
						...
						console.log("oTableViewDelegateColor created with index:",model.index,"display:",model.display);
					}
				}
			}
		}
