...
void ABackend::mInitQMLTypes(void) {
	...
	qmlRegisterType<AEnumsDBDataType>("Arboreus",1,0,"AEnumsDBDataType");
	qRegisterMetaType<AEnumsDBDataType::ADBDataType>(
		"AEnumsDBDataType::ADBDataType"
	);

	qmlRegisterType<AEnumsDBSortingDirection>("Arboreus",1,0,"AEnumsDBSortingDirection");
	qRegisterMetaType<AEnumsDBSortingDirection::ADBSortingDirection>(
		"AEnumsDBSortingDirection::ADBSortingDirection"
	);
}
