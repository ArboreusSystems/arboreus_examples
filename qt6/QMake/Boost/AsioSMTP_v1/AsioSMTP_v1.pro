...
A_PRI_OPENSSL = $$A_DIR_OPENSSL/openssl.pri
exists($$A_PRI_OPENSSL) {
	include($$A_PRI_OPENSSL)
} else {
	error(No OpenSSL config file $$A_PRI_OPENSSL)
}

INCLUDEPATH += $$A_DIR_OPENSSL/static/include
