...
ALibOpenSSL_v2::ALibOpenSSL_v2(QObject* parent) : QObject(parent) {
...
ALibOpenSSL_v2::~ALibOpenSSL_v2(void) {
...
void ALibOpenSSL_v2::mCreateRandom(unsigned char* inKey) {
...
vector<unsigned char> ALibOpenSSL_v2::mEncrypt(
...
string ALibOpenSSL_v2::mDecrypt(
