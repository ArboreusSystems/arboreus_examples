# ---------------------------------
# ATemplates variables

set(A_TEMPLATES_DIR_ROOT ${CMAKE_CURRENT_LIST_DIR})
...
set(A_TARGET_INCLUDE_DIRECTORIES_PRIVATE
	...
	${A_TEMPLATES_DIR_ROOT}
)

set(A_SOURCES_PRECOMPILED_HEADERS_PRIVATE
	${A_SOURCES_PRECOMPILED_HEADERS_PRIVATE}
	${A_TEMPLATES_DIR_ROOT}/atemplatespch.h
)

set(A_SOURCES_CPP_HEADERS
	${A_SOURCES_CPP_HEADERS}
	${A_TEMPLATES_DIR_ROOT}/athreadobjectcontrollertemplate.h
	${A_TEMPLATES_DIR_ROOT}/athreadobjecttemplate.h
	${A_TEMPLATES_DIR_ROOT}/athreadservicetemplate.h
	${A_TEMPLATES_DIR_ROOT}/athreadtemplate.h
)
