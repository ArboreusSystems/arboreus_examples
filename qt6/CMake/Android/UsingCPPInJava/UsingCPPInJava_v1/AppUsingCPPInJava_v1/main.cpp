...
Q_DECLARE_JNI_CLASS(AJavaClass,"systems/arboreus/AJavaPackage/AJavaClass")

static jint mCallbackTest(JNIEnv* inEnvironment, jobject inObject, jint inNumber) {
...
Q_DECLARE_JNI_NATIVE_METHOD(mCallbackTest)
...
Q_DECL_EXPORT jint JNICALL JNI_OnLoad(JavaVM* inJavaVM, void* inReserved) {
	...
	oJNIEnvironment.registerNativeMethods<QtJniTypes::AJavaClass>({
		Q_JNI_NATIVE_METHOD(mCallbackTest)
	});
