...
class VCMain: UIViewController {
	...
	override func viewDidLoad() {
		...
		self.view.addSubview(mLabel(inText: "Swift examples", inY: 0.1, inHeight: 0.05));
		self.view.addSubview(mLabel(inText: "UIKit UICollectionView", inY: 0.15, inHeight: 0.1));
		self.mButtonExit();
	}
