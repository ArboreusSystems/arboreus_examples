...
class MainViewController: UIViewController {
	...
	override func viewDidLayoutSubviews() {
		...
		view.addSubview(mLabel(inText: "Handling Errors", inY: 0.15, inHeight: 0.1));
		
		let oErrorHandler: ErrorHandler = ErrorHandler();
		
		// Uncomment lines for demonstaring errors handling
		
		// oErrorHandler.mTapTrap();
		// oErrorHandler.mTapOptional();
		oErrorHandler.mTapNetwork();
	}
