...
start(_StartType, _StartArgs) ->
	...
	io:format("a_yapp_v2_app addint Yaws ebin path~n"),
	code:add_path(?A_DIR_EBIN_YAWS),

	io:format("a_yapp_v2_app starting~n"),
	a_yapp_v2_sup:start_link().
...
stop(_State) ->
	...
	io:format("a_yapp_v2_app stopping~n"),
	ok.
